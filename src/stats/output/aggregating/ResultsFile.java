...
import static stats.Constants.REPEAT_SHORT_TITLE;
...
public class ResultsFile {
    ...
    /**
     * Key: shortcut title for setup parameter; Value: a ScenarioParamBean
    ...
    /**
     * key: repeat variable short name; Value: the value in Double format. Only
     * double assumed..
     */
    ...
    public ResultsFile(String filePath,
            SortedMap<String, ScenarioParamBean> scenarioSetup,
            Map<String, Double> repeatDetails,
            Statistics stats) {
    ...
    /**
     * @param otherObj
     * @param paramsIgnored Ignores these parameter names (either shortcut or
     * full names) during equality check.
     * @return
     */
    ...
    /**
     * @param title_short
     * @return the ScenarioParamBean regarding the the parameter's shortcut
     * name, or null if no such parameter exists
     */
